...
- testing/dev launches can skip that quit confirmation with `--no-quit-confirmation`; the desktop runtime also still honors `PERSONAL_AGENT_DESKTOP_SKIP_QUIT_CONFIRMATION=1` when you need an environment override
