...
Diffs remain a core workbench surface for now because they are a two-pane interaction: the right rail lists diff targets while the center workbench renders the selected diff.
