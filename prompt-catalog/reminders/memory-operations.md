SYSTEM_REMINDER: This request touches durable memory or profile behavior.

Use the active profile targets already present in system context.

Detailed memory workflow:
