...
export declare function resolveMcpConfig(options?: {
    cwd?: string;
    configPath?: string;
...
export declare function readMcpConfig(options?: {
    cwd?: string;
    configPath?: string;
    env?: NodeJS.ProcessEnv;
}): McpConfigState;
export declare function inspectMcpServer(serverName: string, options?: {
    cwd?: string;
    configPath?: string;
    env?: NodeJS.ProcessEnv;
    timeoutMs?: number;
...
export declare function inspectMcpTool(serverName: string, toolName: string, options?: {
    cwd?: string;
    configPath?: string;
    env?: NodeJS.ProcessEnv;
    timeoutMs?: number;
 ...
 */
export declare function connectMcpServerDirect(server: McpServerConfig, options?: {
    cwd?: string;
    env?: NodeJS.ProcessEnv;
    timeoutMs?: number;
    log?: (message: string) => void;
}): Promise<McpClientConnection>;
export declare function callMcpToolDirect(server: McpServerConfig, toolName: string, input: unknown, options?: {
    cwd?: string;
    env?: NodeJS.ProcessEnv;
    timeoutMs?: number;
    log?: (message: string) => void;
}): Promise<McpOperationResult<McpToolCallResult>>;
export declare function callMcpTool(serverName: string, toolName: string, input: unknown, options?: {
    cwd?: string;
    configPath?: string;
    env?: NodeJS.ProcessEnv;
    timeoutMs?: number;
...
export declare function grepMcpTools(pattern: string, options?: {
    cwd?: string;
    configPath?: string;
    env?: NodeJS.ProcessEnv;
    timeoutMs?: number;
...
export declare function authenticateMcpServer(serverName: string, options?: {
    cwd?: string;
    configPath?: string;
    env?: NodeJS.ProcessEnv;
    timeoutMs?: number;
 ...
 */
export declare function authenticateMcpServerDirect(server: McpServerConfig, options?: {
    env?: NodeJS.ProcessEnv;
    timeoutMs?: number;
    log?: (message: string) => void;
}): Promise<McpOperationResult<McpServerInfo>>;
export declare function clearMcpServerAuth(serverName: string, options?: {
    cwd?: string;
    configPath?: string;
    env?: NodeJS.ProcessEnv;
}): Promise<void>;
