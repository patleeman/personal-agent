...
export declare function resolveTaskCallbackBindingsFile(options: { profile: string; stateRoot?: string }): string;
export declare function loadTaskCallbackBindings(options: { profile: string; stateRoot?: string }): Record<string, TaskCallbackBinding>;
...
export declare function clearTaskCallbackBinding(options: { profile: string; taskId: string; stateRoot?: string }): boolean;
