...
function formatProjectState(document) {
    ...
    return {
        ...
        requirements: {
            ...
            acceptanceCriteria: document.requirements.acceptanceCriteria.map((criterion, index) => assertNonEmptyText(criterion, `Project requirements.acceptanceCriteria[${index}]`)),
        },
