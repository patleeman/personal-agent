 ...
 */
async function validateStateDirectory(dirPath, label) {
 ...
 */
export async function bootstrapState(paths) {
    const errors = [];
 ...
 */
export async function bootstrapStateOrThrow(paths) {
...
async function canCreateOrWriteDirectory(path) {
 ...
 */
export async function canBootstrap(paths) {
