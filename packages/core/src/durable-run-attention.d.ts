...
export declare function saveDurableRunAttentionState(
  options: DurableRunAttentionStateOptions & {
    document: DurableRunAttentionStateDocument;
  },
): string;
export declare function markDurableRunAttentionRead(
  options: DurableRunAttentionStateOptions & {
    runId: string;
    attentionSignature: string;
    readAt?: string;
...
export declare function markDurableRunAttentionUnread(
  options: DurableRunAttentionStateOptions & {
    runId: string;
  },
): DurableRunAttentionStateDocument;
export declare function isDurableRunAttentionDismissed(
  options: DurableRunAttentionStateOptions & {
    runId: string;
    attentionSignature: string;
  },
