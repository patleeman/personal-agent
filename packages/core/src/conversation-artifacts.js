...
const ARTIFACT_KINDS = ['html', 'mermaid', 'latex'];
function getConversationArtifactStateRoot(stateRoot) {
...
export function validateConversationArtifactId(artifactId) {
...
export function validateConversationArtifactKind(kind) {
...
function slugifyArtifactId(input) {
    const slug = input
        .toLowerCase()
        .replace(/[^a-z0-9._-]+/g, '-')
        .replace(/^-+|-+$/g, '')
...
function createUniqueArtifactId(options) {
...
export function resolveProfileConversationArtifactsDir(options) {
...
export function resolveConversationArtifactsDir(options) {
    validateProfileName(options.profile);
...
export function resolveConversationArtifactPath(options) {
    validateProfileName(options.profile);
    validateConversationId(options.conversationId);
...
export function readConversationArtifact(path) {
...
export function getConversationArtifact(options) {
...
export function listConversationArtifacts(options) {
...
export function deleteConversationArtifact(options) {
    const path = resolveConversationArtifactPath(options);
    if (!existsSync(path)) {
        return false;
    }
