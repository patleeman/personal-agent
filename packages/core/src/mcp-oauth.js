...
import { OAuthClientInformationFullSchema, OAuthProtectedResourceMetadataSchema, OAuthTokensSchema, } from '@modelcontextprotocol/sdk/shared/auth.js';
import open from 'open';
import { checkLockfile, createLockfile, deleteConfigFile, deleteLockfile, readJsonFile, readTextFile, writeJsonFile, writeTextFile, } from './mcp-auth-storage.js';
...
function setupOAuthCallbackServer(options) {
    ...
    const server = createServer((req, res) => {
        ...
        writeText(res, 200, '<html><body><h1>Authorization successful</h1><p>You may close this window and return to the CLI.</p><script>window.close()</script></body></html>', 'text/html; charset=utf-8');
    });
