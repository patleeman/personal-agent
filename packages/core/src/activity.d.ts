...
export declare function saveProfileActivityReadState(options: ResolveActivityOptions & {
    ids: Iterable<string>;
}): string;
...
export declare function deleteProfileActivityEntries(options: ResolveActivityOptions & {
