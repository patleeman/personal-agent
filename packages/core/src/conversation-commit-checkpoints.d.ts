declare const CHECKPOINT_FILE_STATUS_VALUES: readonly ["added", "modified", "deleted", "renamed", "copied", "typechange", "unmerged", "unknown"];
...
export declare function resolveProfileConversationCommitCheckpointsDir(options: {
    profile: string;
    stateRoot?: string;
}): string;
...
export declare function getConversationCommitCheckpoint(options: ResolveConversationCommitCheckpointPathOptions): ConversationCommitCheckpointRecord | null;
export declare function listConversationCommitCheckpoints(options: ResolveConversationCommitCheckpointOptions): ConversationCommitCheckpointSummary[];
