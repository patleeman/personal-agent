...
export declare function resolveProfileConversationAttachmentsDir(options: {
    profile: string;
    stateRoot?: string;
}): string;
...
export declare function resolveConversationAttachmentRevisionDir(options: ResolveConversationAttachmentPathOptions & {
    revision: number;
}): string;
...
export declare function saveConversationAttachment(options: ResolveConversationAttachmentOptions & {
    attachmentId?: string;
    kind?: ConversationAttachmentKind;
    title?: string;
    sourceData: string;
...
export declare function readConversationAttachmentDownload(options: ResolveConversationAttachmentPathOptions & {
...
export declare function resolveConversationAttachmentPromptFiles(options: ResolveConversationAttachmentOptions & {
