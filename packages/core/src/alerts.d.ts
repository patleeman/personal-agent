...
export declare function saveAlertState(
  options: ResolveAlertOptions & {
    state: AlertStateFile;
  },
): string;
export declare function listAlerts(
  options?: ResolveAlertOptions & {
    includeDismissed?: boolean;
    includeAcknowledged?: boolean;
  },
): AlertRecord[];
export declare function getAlert(
  options: ResolveAlertOptions & {
    alertId: string;
  },
): AlertRecord | undefined;
export declare function upsertAlert(
  options: ResolveAlertOptions & {
...
export declare function acknowledgeAlert(
  options: ResolveAlertOptions & {
    alertId: string;
    at?: string;
  },
): AlertRecord | undefined;
export declare function dismissAlert(
  options: ResolveAlertOptions & {
    alertId: string;
    at?: string;
  },
