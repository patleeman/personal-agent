...
export declare function getActivityConversationLink(
  options: ResolveActivityConversationLinkPathOptions,
...
export declare function clearActivityConversationLinks(options: { stateRoot?: string; profile: string; activityId: string }): void;
