...
import type { ExtensionNewConversationPanelRegistration } from './useExtensionRegistry';

export interface NewConversationPanelContext {
  conversationId: string;
  suggestedContext?: unknown;
  [key: string]: unknown;
}

type NewConversationPanelComponent = ComponentType<{
...
export function NewConversationPanelHost({
  registration,
  panelContext,
}: {
  registration: ExtensionNewConversationPanelRegistration;
  panelContext: NewConversationPanelContext;
}) {
  ...
  const Component = useMemo(
    () =>
      lazy(async () => {
        ...
        const component = module[registration.component] as NewConversationPanelComponent | undefined;
  ...
  return (
    <Suspense fallback={null}>
      <Component pa={pa} panelContext={panelContext} />
    </Suspense>
  );
}
