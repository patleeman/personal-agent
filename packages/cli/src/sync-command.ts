...
import {
  ...
  getStateRoot,
  getSyncRoot,
  managedSyncRepoGitignore as renderManagedSyncRepoGitignore,
  managedSyncRepoGitattributes as renderManagedSyncRepoGitattributes,
  managedSyncRepoReadme as renderManagedSyncRepoReadme,
...
export function syncRepoGitattributes(): string {
  return renderManagedSyncRepoGitattributes(CONVERSATION_ATTENTION_MERGE_DRIVER);
}
...
function syncRepoReadme(): string {
  return renderManagedSyncRepoReadme();
}
