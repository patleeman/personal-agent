...
import { buildConversationTitleTranscript, generateConversationTitle, normalizeGeneratedConversationTitle, readConversationAutoTitleSettings, } from './conversationAutoTitle.js';
const tempDirs = [];
afterEach(() => {
...
describe('generateConversationTitle', () => {
    it('prompts the configured small model with transcript-only messages and normalizes the result', async () => {
        ...
        expect(completeSimpleMock).toHaveBeenCalledWith(model, expect.objectContaining({
