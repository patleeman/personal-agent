...
import { createProjectScaffold, createProjectTask, resolveProjectTaskPath, writeProjectTask, } from '@personal-agent/core';
...
describe('readProjectDetailFromProject', () => {
    it('returns summary, plan, and sorted tasks from project storage', () => {
        ...
        writeProjectTask(resolveProjectTaskPath({ repoRoot, profile: 'datadog', projectId: 'web-ui', taskId: 'completed-task' }), createProjectTask({
            id: 'completed-task',
        ...
        writeProjectTask(resolveProjectTaskPath({ repoRoot, profile: 'datadog', projectId: 'web-ui', taskId: 'running-task' }), createProjectTask({
            id: 'running-task',
