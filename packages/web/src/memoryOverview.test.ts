...
const MEMORY_DATA: MemoryData = {
  ...
  skills: [
    ...
    },
    {
      ...
      path: '/state/profiles/shared/agent/skills/tool-agent-browser/SKILL.md',
  ...
  memoryDocs: [
    {
      ...
      tags: ['sql', 'heuristic'],
      type: 'pattern',
      path: '/state/profiles/_memory/sql-heuristics/MEMORY.md',
      recentSessionCount: 1,
    ...
    },
    {
      ...
      type: 'reference',
      path: '/state/profiles/_memory/atlas-guide/MEMORY.md',
      recentSessionCount: 0,
      lastUsedAt: null,
      usedInLastSession: false,
    },
