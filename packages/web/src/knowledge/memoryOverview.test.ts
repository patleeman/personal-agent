  ...
  skills: [
    {
      ...
      path: '/state/profiles/shared/agent/skills/create-pr/INDEX.md',
    ...
    },
    {
      ...
      path: '/repo/profiles/datadog/agent/skills/dd-oncall/INDEX.md',
  ...
  memoryDocs: [
    {
      ...
      tags: ['sql', 'heuristic'],
      type: 'pattern',
      path: '/state/sync/notes/sql-heuristics/INDEX.md',
      recentSessionCount: 1,
    ...
    },
    {
      ...
      type: 'reference',
      path: '/state/sync/notes/atlas-guide/INDEX.md',
      recentSessionCount: 0,
      lastUsedAt: null,
      usedInLastSession: false,
    },
