...
export function PageEditorDocument({
  title,
  onTitleChange,
  description,
  onDescriptionChange,
  ...
  descriptionPlaceholder = 'Tell the agent how to use this page, when to read it, or what it is for.',
  descriptionLabel = 'For the agent (optional)',
      ...
      <div className={documentClassName ? `ui-note-editor-doc ${documentClassName}` : 'ui-note-editor-doc'}>
        ...
        {showDescription ? (
          <label className="ui-note-description-block">
            <span className="ui-note-description-label">{descriptionLabel}</span>
            <textarea
              value={description}
