  ...
  return (
    ...
    >
      <div
        ...
        style={{ width: 'min(96vw, 1600px)', height: 'min(calc(100vh - 2rem), 1080px)', maxHeight: 'calc(100vh - 2rem)' }}
      >
        ...
        <div className="min-h-0 flex flex-1 flex-col overflow-hidden bg-base lg:flex-row">
          <aside className="flex w-full shrink-0 flex-col border-b border-border-subtle bg-base/50 lg:w-[clamp(15rem,22vw,20rem)] lg:border-b-0 lg:border-r">
            <div className="border-b border-border-subtle px-4 py-3">
              <p className="ui-section-label">Files</p>
            </div>
            <div className="min-h-0 max-h-52 flex-1 overflow-y-auto px-2 py-2 lg:max-h-none">
