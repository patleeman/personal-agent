...
export const api = {
  ...
  mergeMemoryDoc: (memoryId: string, targetMemoryId: string) =>
    post<MergeMemoryDocResult>(`/memories/${encodeURIComponent(memoryId)}/merge`, { targetMemoryId }),
