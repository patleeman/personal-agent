...
- current focus after this slice: cleanup leverage is nearly exhausted, so the next strongest move is to switch back to packaged-Electron new-conversation/first-response perf measurement unless one final truly dead surface is obvious
