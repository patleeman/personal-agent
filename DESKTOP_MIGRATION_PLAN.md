...
- current focus after this slice: cleanup leverage is now thinner still, so the next strongest move is to return to packaged local first-response / first-visible-update perf measurement
