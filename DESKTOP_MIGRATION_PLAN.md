...
- current focus after this slice: keep measuring the packaged local path for the next strongest first-response/first-visible-update delay rather than chasing increasingly thin dead-surface cleanup
