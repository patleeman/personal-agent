...
sonarr_api GET "/api/v3/wanted/missing?page=$page&pageSize=$page_size" \
  | jq '{page, pageSize, totalRecords, records: [.records[] | {seriesId, title, seasonNumber, episodeNumber}]}'
