...
const RUN_ACTION_VALUES = ['list', 'get', 'logs', 'start', 'start_agent', 'rerun', 'follow_up', 'cancel'];
...
function normalizeRunLogTail(value) {
        ...
        try {
          switch (params.action) {
            case 'list': {
              ...
              return {
                content: [{ type: 'text', text: formatRunList(result) }],
                details: {
                  action: 'list',
            ...
            case 'get': {
              ...
              return {
                content: [{ type: 'text', text: formatRunDetail(result) }],
                details: {
                  action: 'get',
                  runId,
            ...
            case 'rerun': {
              ...
              invalidateAppTopics('runs');
              return {
                content: [{ type: 'text', text: `Started rerun ${result.runId} from ${runId}.` }],
                details: {
                  action: 'rerun',
                  runId: result.runId,
                  sourceRunId: runId,
            ...
            case 'follow_up': {
              ...
              invalidateAppTopics('runs');
              return {
                content: [{ type: 'text', text: `Started follow-up run ${result.runId} from ${runId}.` }],
                details: {
                  action: 'follow_up',
                  runId: result.runId,
                  sourceRunId: runId,
            ...
            case 'cancel': {
              ...
              invalidateAppTopics('runs');
              return {
                content: [{ type: 'text', text: `Cancelled durable run ${runId}.` }],
                details: {
                  action: 'cancel',
                  runId,
                  cancelled: true,
